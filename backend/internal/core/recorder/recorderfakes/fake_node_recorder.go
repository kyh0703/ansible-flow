...
func (fake *FakeNodeRecorder) DeleteOne(arg1 context.Context, arg2 int64) error {
...
func (fake *FakeNodeRecorder) DeleteOneCalls(stub func(context.Context, int64) error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
	fake.DeleteOneStub = stub
}

func (fake *FakeNodeRecorder) DeleteOneArgsForCall(i int) (context.Context, int64) {
	fake.deleteOneMutex.RLock()
	defer fake.deleteOneMutex.RUnlock()
...
func (fake *FakeNodeRecorder) FindOne(arg1 context.Context, arg2 int64) (model.Node, error) {
...
func (fake *FakeNodeRecorder) FindOneCalls(stub func(context.Context, int64) (model.Node, error)) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = stub
}

func (fake *FakeNodeRecorder) FindOneArgsForCall(i int) (context.Context, int64) {
	fake.findOneMutex.RLock()
	defer fake.findOneMutex.RUnlock()
...
func (fake *FakeNodeRecorder) UpdateOne(arg1 context.Context, arg2 model.PatchNodeParams) error {
...
func (fake *FakeNodeRecorder) UpdateOneCalls(stub func(context.Context, model.PatchNodeParams) error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = stub
}

func (fake *FakeNodeRecorder) UpdateOneArgsForCall(i int) (context.Context, model.PatchNodeParams) {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
