...
type FakeEdgeRecorder struct {
	...
	FindOneStub        func(context.Context, int64) (model.Edge, error)
	...
	UpdateOneStub        func(context.Context, model.PatchEdgeParams) error
...
func (fake *FakeEdgeRecorder) DeleteOne(arg1 context.Context, arg2 int64) error {
...
func (fake *FakeEdgeRecorder) DeleteOneCalls(stub func(context.Context, int64) error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
	fake.DeleteOneStub = stub
}

func (fake *FakeEdgeRecorder) DeleteOneArgsForCall(i int) (context.Context, int64) {
	fake.deleteOneMutex.RLock()
	defer fake.deleteOneMutex.RUnlock()
...
func (fake *FakeEdgeRecorder) FindOne(arg1 context.Context, arg2 int64) (model.Edge, error) {
...
func (fake *FakeEdgeRecorder) FindOneCalls(stub func(context.Context, int64) (model.Edge, error)) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = stub
}

func (fake *FakeEdgeRecorder) FindOneArgsForCall(i int) (context.Context, int64) {
	fake.findOneMutex.RLock()
	defer fake.findOneMutex.RUnlock()
...
func (fake *FakeEdgeRecorder) UpdateOne(arg1 context.Context, arg2 model.PatchEdgeParams) error {
...
func (fake *FakeEdgeRecorder) UpdateOneCalls(stub func(context.Context, model.PatchEdgeParams) error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = stub
}

func (fake *FakeEdgeRecorder) UpdateOneArgsForCall(i int) (context.Context, model.PatchEdgeParams) {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
