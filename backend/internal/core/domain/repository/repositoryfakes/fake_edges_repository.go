...
type FakeEdgesRepository struct {
	...
	FindOneStub        func(context.Context, int64) (*entity.Edge, error)
...
func (fake *FakeEdgesRepository) CreateOne(arg1 context.Context, arg2 entity.Edge) (*entity.Edge, error) {
...
func (fake *FakeEdgesRepository) CreateOneCallCount() int {
	fake.createOneMutex.RLock()
	defer fake.createOneMutex.RUnlock()
	return len(fake.createOneArgsForCall)
}

func (fake *FakeEdgesRepository) CreateOneCalls(stub func(context.Context, entity.Edge) (*entity.Edge, error)) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
	fake.CreateOneStub = stub
}

func (fake *FakeEdgesRepository) CreateOneArgsForCall(i int) (context.Context, entity.Edge) {
	fake.createOneMutex.RLock()
	defer fake.createOneMutex.RUnlock()
...
func (fake *FakeEdgesRepository) CreateOneReturns(result1 *entity.Edge, result2 error) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
...
func (fake *FakeEdgesRepository) CreateOneReturnsOnCall(i int, result1 *entity.Edge, result2 error) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
	fake.CreateOneStub = nil
...
func (fake *FakeEdgesRepository) DeleteOne(arg1 context.Context, arg2 int64) error {
...
func (fake *FakeEdgesRepository) DeleteOneCallCount() int {
	fake.deleteOneMutex.RLock()
	defer fake.deleteOneMutex.RUnlock()
	return len(fake.deleteOneArgsForCall)
}

func (fake *FakeEdgesRepository) DeleteOneCalls(stub func(context.Context, int64) error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
	fake.DeleteOneStub = stub
}

func (fake *FakeEdgesRepository) DeleteOneArgsForCall(i int) (context.Context, int64) {
	fake.deleteOneMutex.RLock()
	defer fake.deleteOneMutex.RUnlock()
...
func (fake *FakeEdgesRepository) DeleteOneReturns(result1 error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
...
func (fake *FakeEdgesRepository) DeleteOneReturnsOnCall(i int, result1 error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
	fake.DeleteOneStub = nil
...
func (fake *FakeEdgesRepository) FindOne(arg1 context.Context, arg2 int64) (*entity.Edge, error) {
...
func (fake *FakeEdgesRepository) FindOneCallCount() int {
	fake.findOneMutex.RLock()
	defer fake.findOneMutex.RUnlock()
	return len(fake.findOneArgsForCall)
}

func (fake *FakeEdgesRepository) FindOneCalls(stub func(context.Context, int64) (*entity.Edge, error)) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = stub
}

func (fake *FakeEdgesRepository) FindOneArgsForCall(i int) (context.Context, int64) {
	fake.findOneMutex.RLock()
	defer fake.findOneMutex.RUnlock()
...
func (fake *FakeEdgesRepository) FindOneReturns(result1 *entity.Edge, result2 error) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
...
func (fake *FakeEdgesRepository) FindOneReturnsOnCall(i int, result1 *entity.Edge, result2 error) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = nil
...
func (fake *FakeEdgesRepository) UpdateOne(arg1 context.Context, arg2 entity.Edge) error {
...
func (fake *FakeEdgesRepository) UpdateOneCallCount() int {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
	return len(fake.updateOneArgsForCall)
}

func (fake *FakeEdgesRepository) UpdateOneCalls(stub func(context.Context, entity.Edge) error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = stub
}

func (fake *FakeEdgesRepository) UpdateOneArgsForCall(i int) (context.Context, entity.Edge) {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
...
func (fake *FakeEdgesRepository) UpdateOneReturns(result1 error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
...
func (fake *FakeEdgesRepository) UpdateOneReturnsOnCall(i int, result1 error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = nil
