...
type FakeProjectRepository struct {
	...
	GetListStub        func(context.Context, int64) ([]model.Project, error)
	...
	GetListWithPagingStub        func(context.Context, int64, int, int) ([]model.Project, int64, error)
	getListWithPagingMutex       sync.RWMutex
	getListWithPagingArgsForCall []struct {
		arg1 context.Context
		arg2 int64
		arg3 int
		arg4 int
	}
	getListWithPagingReturns struct {
		result1 []model.Project
		result2 int64
		result3 error
	}
	getListWithPagingReturnsOnCall map[int]struct {
		result1 []model.Project
		result2 int64
		result3 error
	}
...
func (fake *FakeProjectRepository) GetList(arg1 context.Context, arg2 int64) ([]model.Project, error) {
...
func (fake *FakeProjectRepository) GetListCalls(stub func(context.Context, int64) ([]model.Project, error)) {
	fake.getListMutex.Lock()
	defer fake.getListMutex.Unlock()
	fake.GetListStub = stub
}

func (fake *FakeProjectRepository) GetListArgsForCall(i int) (context.Context, int64) {
	fake.getListMutex.RLock()
	defer fake.getListMutex.RUnlock()
...
func (fake *FakeProjectRepository) GetListWithPaging(arg1 context.Context, arg2 int64, arg3 int, arg4 int) ([]model.Project, int64, error) {
	fake.getListWithPagingMutex.Lock()
	ret, specificReturn := fake.getListWithPagingReturnsOnCall[len(fake.getListWithPagingArgsForCall)]
	fake.getListWithPagingArgsForCall = append(fake.getListWithPagingArgsForCall, struct {
		arg1 context.Context
		arg2 int64
		arg3 int
		arg4 int
	}{arg1, arg2, arg3, arg4})
	stub := fake.GetListWithPagingStub
	fakeReturns := fake.getListWithPagingReturns
	fake.recordInvocation("GetListWithPaging", []interface{}{arg1, arg2, arg3, arg4})
	fake.getListWithPagingMutex.Unlock()
	if stub != nil {
...
func (fake *FakeProjectRepository) GetListWithPagingCallCount() int {
	fake.getListWithPagingMutex.RLock()
	defer fake.getListWithPagingMutex.RUnlock()
	return len(fake.getListWithPagingArgsForCall)
}

func (fake *FakeProjectRepository) GetListWithPagingCalls(stub func(context.Context, int64, int, int) ([]model.Project, int64, error)) {
	fake.getListWithPagingMutex.Lock()
	defer fake.getListWithPagingMutex.Unlock()
	fake.GetListWithPagingStub = stub
}

func (fake *FakeProjectRepository) GetListWithPagingArgsForCall(i int) (context.Context, int64, int, int) {
	fake.getListWithPagingMutex.RLock()
	defer fake.getListWithPagingMutex.RUnlock()
	argsForCall := fake.getListWithPagingArgsForCall[i]
	return argsForCall.arg1, argsForCall.arg2, argsForCall.arg3, argsForCall.arg4
}

func (fake *FakeProjectRepository) GetListWithPagingReturns(result1 []model.Project, result2 int64, result3 error) {
	fake.getListWithPagingMutex.Lock()
	defer fake.getListWithPagingMutex.Unlock()
	fake.GetListWithPagingStub = nil
	fake.getListWithPagingReturns = struct {
		result1 []model.Project
		result2 int64
		result3 error
...
func (fake *FakeProjectRepository) GetListWithPagingReturnsOnCall(i int, result1 []model.Project, result2 int64, result3 error) {
	fake.getListWithPagingMutex.Lock()
	defer fake.getListWithPagingMutex.Unlock()
	fake.GetListWithPagingStub = nil
	if fake.getListWithPagingReturnsOnCall == nil {
		fake.getListWithPagingReturnsOnCall = make(map[int]struct {
			result1 []model.Project
			result2 int64
			result3 error
		})
	}
	fake.getListWithPagingReturnsOnCall[i] = struct {
		result1 []model.Project
		result2 int64
		result3 error
	}{result1, result2, result3}
...
func (fake *FakeProjectRepository) UpdateOne(arg1 context.Context, arg2 model.PatchProjectParams) error {
...
func (fake *FakeProjectRepository) UpdateOneCalls(stub func(context.Context, model.PatchProjectParams) error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = stub
}

func (fake *FakeProjectRepository) UpdateOneArgsForCall(i int) (context.Context, model.PatchProjectParams) {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
