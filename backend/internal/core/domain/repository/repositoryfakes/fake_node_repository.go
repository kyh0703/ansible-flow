...
type FakeNodeRepository struct {
	...
	FindOneStub        func(context.Context, int64) (model.Node, error)
...
func (fake *FakeNodeRepository) DeleteOne(arg1 context.Context, arg2 int64) error {
...
func (fake *FakeNodeRepository) DeleteOneCalls(stub func(context.Context, int64) error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
	fake.DeleteOneStub = stub
}

func (fake *FakeNodeRepository) DeleteOneArgsForCall(i int) (context.Context, int64) {
	fake.deleteOneMutex.RLock()
	defer fake.deleteOneMutex.RUnlock()
...
func (fake *FakeNodeRepository) FindOne(arg1 context.Context, arg2 int64) (model.Node, error) {
...
func (fake *FakeNodeRepository) FindOneCalls(stub func(context.Context, int64) (model.Node, error)) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = stub
}

func (fake *FakeNodeRepository) FindOneArgsForCall(i int) (context.Context, int64) {
	fake.findOneMutex.RLock()
	defer fake.findOneMutex.RUnlock()
...
func (fake *FakeNodeRepository) UpdateOne(arg1 context.Context, arg2 model.PatchNodeParams) error {
...
func (fake *FakeNodeRepository) UpdateOneCalls(stub func(context.Context, model.PatchNodeParams) error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = stub
}

func (fake *FakeNodeRepository) UpdateOneArgsForCall(i int) (context.Context, model.PatchNodeParams) {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
