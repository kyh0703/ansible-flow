...
func (fake *FakeFlowRepository) UpdateOne(arg1 context.Context, arg2 model.PatchFlowParams) error {
...
func (fake *FakeFlowRepository) UpdateOneCalls(stub func(context.Context, model.PatchFlowParams) error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = stub
}

func (fake *FakeFlowRepository) UpdateOneArgsForCall(i int) (context.Context, model.PatchFlowParams) {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
