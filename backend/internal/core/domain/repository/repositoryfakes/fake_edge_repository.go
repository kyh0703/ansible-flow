...
func (fake *FakeEdgeRepository) DeleteOne(arg1 context.Context, arg2 int64) error {
...
func (fake *FakeEdgeRepository) DeleteOneCalls(stub func(context.Context, int64) error) {
	fake.deleteOneMutex.Lock()
	defer fake.deleteOneMutex.Unlock()
	fake.DeleteOneStub = stub
}

func (fake *FakeEdgeRepository) DeleteOneArgsForCall(i int) (context.Context, int64) {
	fake.deleteOneMutex.RLock()
	defer fake.deleteOneMutex.RUnlock()
...
func (fake *FakeEdgeRepository) FindOne(arg1 context.Context, arg2 int64) (*entity.Edge, error) {
...
func (fake *FakeEdgeRepository) FindOneCalls(stub func(context.Context, int64) (*entity.Edge, error)) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = stub
}

func (fake *FakeEdgeRepository) FindOneArgsForCall(i int) (context.Context, int64) {
	fake.findOneMutex.RLock()
	defer fake.findOneMutex.RUnlock()
